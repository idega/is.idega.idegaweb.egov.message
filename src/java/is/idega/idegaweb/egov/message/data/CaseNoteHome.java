 ...
 * @version $Revision$
 */
public interface CaseNoteHome extends MessageHome {

    /**
     * @see se.idega.idegaweb.commune.message.data.CaseNoteBMPBean#ejbFindMessages
     */
    @Override
	public Collection findMessages(User user) throws FinderException;

    /**
     * @see se.idega.idegaweb.commune.message.data.CaseNoteBMPBean#ejbFindMessagesByStatus
     */
    ...
    /**
     * @see se.idega.idegaweb.commune.message.data.CaseNoteBMPBean#ejbHomeGetNumberOfMessagesByStatus
     */
    ...
    /**
     * @see se.idega.idegaweb.commune.message.data.CaseNoteBMPBean#ejbHomeGetNumberOfMessages
     */
    @Override
